  ...
  const definitions = [
    {
      ...
      color: 'reward.common', shape: { kind: 'poly', sides: 6, rot: 0 },
      weight: 15, duration: null, pips: 3
    },
    {
      key: 'spread', label: 'SPREAD', letter: 'S', slot: 'weapon',
      color: 'reward.rare', shape: { kind: 'poly', sides: 3, rot: Math.PI / 2 },
      weight: 15, duration: null, pips: 3
    },
    {
    ...
    },
    {
      ...
      color: 'reward.tech', shape: { kind: 'star', points: 6, inner: 0.46, rot: 0 },
      weight: 5, duration: 8000, pips: 3, rare: true, impact: 1.25
    },
    {
      key: 'arsenal', label: 'ARSENAL', letter: 'C', slot: 'instant',
      color: 'reward.rare', shape: { kind: 'poly', sides: 8, rot: Math.PI / 8 },
